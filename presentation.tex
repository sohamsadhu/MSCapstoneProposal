...
\footnotetext[5]{Information Technology Laboratory, National Institute of Standards and Technology.
...
\begin{figure}[h]
  ...
  \label{fig:lab}
\end{figure}
\footnotetext[6]{Guido Bertoni, Joan Daemen, Micha\"{e}l Peeters, and Gilles Van Assche. Cryptographic
sponge functions. http://sponge.noekeon.org/CSF-0.1.pdf, January 2011.}
\end{frame}

\begin{frame}
\frametitle{State \footnotemark}
\begin{figure}[h]
  \begin{center}
    \includegraphics[scale=0.21]{keccakstateterminology.jpg}
  \end{center}
  %\caption{Keccak state terminology $Z = Sponge[f, pad, r](M, l)$\footnotemark}
  %\label{fig:lab}
\end{figure}
\footnotetext[7]{Guido Bertoni, Joan Daemen, Micha\"{e}l Peeters, and Gilles Van Assche. The keccak 
...
\begin{figure}[h]
  ...
  \label{fig:seq}
\end{figure}
\footnotetext[8]{Eli Biham and Orr Dunkelman. A framework for iterative hash functions - haifa.
...
%\begin{frame}
%\frametitle{Initial values and rounds}
%\begin{table}[h]
%  \begin{center}
...
%  \end{center}
%\end{table}
%\footnotetext[10]{S{\o}ren Steffen Thomsen, Martin Schl\"{a}ffer, Christian Rechberger, Florian Mendel,
...
\footnotetext[10]{S{\o}ren Steffen Thomsen, Martin Schl\"{a}ffer, Christian Rechberger, Florian Mendel,
Krystian Matusiewicz, Lars R. Knudsen, and Praveen Gauravaram. Grøstl - a sha-3
candidate version 2.0.1. http://www.groestl.info/Groestl.pdf}
\end{frame}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[scale=0.36]{groestlPQfunction.jpg}
  \end{center}
  \caption{P and Q are $l-bit$ permutations \footnotemark}
  \label{fig:lab}
\end{figure}
\footnotetext[11]{S{\o}ren Steffen Thomsen, Martin Schl\"{a}ffer, Christian Rechberger, Florian Mendel,
Krystian Matusiewicz, Lars R. Knudsen, and Praveen Gauravaram. Grøstl - a sha-3
candidate version 2.0.1. http://www.groestl.info/Groestl.pdf}
\end{frame}
...
\begin{figure}[h]
  ...
  \label{fig:lab}
\end{figure}
\footnotetext[12]{S{\o}ren Steffen Thomsen, Martin Schl\"{a}ffer, Christian Rechberger, Florian Mendel,
Krystian Matusiewicz, Lars R. Knudsen, and Praveen Gauravaram. Grøstl - a sha-3
candidate version 2.0.1. http://www.groestl.info/Groestl.pdf}
\end{frame}
...
\end{algorithm}
\footnotetext[13]{Meltem S\"{o}nmez Turan and Erdener Uyan. Practical near-collisions for reduced round blake, 
fugue, hamsi and jh. Second SHA-3 conference, August 2010. 
http://csrc.nist.gov/groups/ST/hash/sha-3/Round2/Aug2010/documents/papers/TURAN\_Paper\_Erdener.pdf.}
\end{frame}
