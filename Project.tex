...
\title{Evaluation of hill climbing, simulated annealing, tabu search
       and random selection: search algorithms on cryptographic hash functions Keccak, 
       BLAKE, and Gr{\o}stl}
% The \titleline{} must have no line breaks in it.
\titleline{Evaluation of hill climbing, simulated annealing, tabu search and random 
selection: search algorithms on cryptographic hash functions Keccak, BLAKE, and Gr{\o}stl}
