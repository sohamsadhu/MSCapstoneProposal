...
simulated annealing against random search, for reduced versions of hash function. In theory for an ideal hashing
...
deficiencies \cite{00030, 00032}. Other than particular attacks like zero-sum property has been tested on 
