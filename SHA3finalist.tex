...
structure rather than linear strings, or two dimensional arrays.
  ...
  \begin{algorithm}
    ...
    \begin{algorithmic}[1]
      ...
      \State $s = 0^{b}$
      \For {$i = 0 \thickspace to \mid P \mid_{r} - 1$}
  ...
  Algorithm 3.1 shows how the sponge construction applied to $KECCAK-f[r + c]$, with multi-rate padding, where length of
  ...
  \begin{algorithm}
    ...
    \begin{algorithmic}[1]
      \For {$y = 0 \thickspace to \thickspace 4$}
      \For {$x = 0 \thickspace to \thickspace 4$}
  ...
  \begin{algorithm}
    ...
    \begin{algorithmic}[1]
      \For {$x = 0 \thickspace to \thickspace 4$}
      \State $C[x] = a[x, 0]$
      \For {$y = 1 \thickspace to \thickspace 4$}
      $C[x] = C[x] \oplus a[x, y]$
      \EndFor
      \EndFor
      \For {$x = 0 \thickspace to \thickspace 4$}
  ...
  \begin{algorithm}
    ...
    \begin{algorithmic}[1]
      ...
      \For{$t = 0 \thickspace to \thickspace 23$}
